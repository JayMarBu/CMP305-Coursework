...
float4 main(InputType input) : SV_TARGET
{
	...
	colour += shaderTexture.Sample(SampleType, input.tex + float2(0.0f, texelSize * -7.0f)) * weight4;
	colour += shaderTexture.Sample(SampleType, input.tex + float2(0.0f, texelSize * -6.0f)) * weight4;
	colour += shaderTexture.Sample(SampleType, input.tex + float2(0.0f, texelSize * -5.0f)) * weight4;
