...
float4 main(InputType input) : SV_TARGET
{
	...
	colour += shaderTexture.Sample(SampleType, input.tex + float2(texelSize * -7.0f, 0.0f)) * weight4;
	colour += shaderTexture.Sample(SampleType, input.tex + float2(texelSize * -6.0f, 0.0f)) * weight4;
	colour += shaderTexture.Sample(SampleType, input.tex + float2(texelSize * -5.0f, 0.0f)) * weight4;
